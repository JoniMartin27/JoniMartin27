<p align="center">
  <a href="https://fervon.dev">
    <img src="https://raw.githubusercontent.com/Fervon/fervon/main/assets/logo.png" alt="Fervon — estudio de software autónomo" width="104">
  </a>
</p>

<h1 align="center">Jonathan Martín</h1>

<p align="center">
  <strong>Construyo sistemas de agentes de IA y las herramientas que los rodean.</strong><br>
  Todo lo que hago vive bajo <a href="https://fervon.dev"><strong>Fervon</strong></a> — mi estudio de software autónomo.<br>
...
Trabajo de punta a punta — backend en TypeScript y Python, interfaces en React, apps de escritorio en Electron, infraestructura en Cloudflare y un laboratorio doméstico sobre Raspberry Pi donde se prueba todo antes de salir.
...
Productos con página propia, capturas, precio y descarga. Cada uno tiene su sitio en **[fervon.dev](https://fervon.dev)**.
...
Nada de registro, nada de cuenta. Un comando y corre en tu máquina:

```bash
npx lookspan              # observabilidad local-first para tus agentes
npx claudescope-cli       # analítica y búsqueda de tus sesiones de Claude Code
npx @fervon/launchpad     # levanta todos tus proyectos a la vez
pip install lookspan      # el SDK de Lookspan, también en Python
```

<p>
  <a href="https://www.npmjs.com/package/lookspan"><img src="https://img.shields.io/npm/v/lookspan?label=lookspan&color=ff6a00&labelColor=1a1310" alt="lookspan en npm"></a>
  <a href="https://pypi.org/project/lookspan/"><img src="https://img.shields.io/pypi/v/lookspan?label=PyPI%20lookspan&color=ff6a00&labelColor=1a1310" alt="lookspan en PyPI"></a>
  <a href="https://www.npmjs.com/package/claudescope-cli"><img src="https://img.shields.io/npm/v/claudescope-cli?label=claudescope-cli&color=ff6a00&labelColor=1a1310" alt="claudescope-cli en npm"></a>
  <a href="https://www.npmjs.com/package/@fervon/launchpad"><img src="https://img.shields.io/npm/v/@fervon/launchpad?label=%40fervon%2Flaunchpad&color=ff6a00&labelColor=1a1310" alt="@fervon/launchpad en npm"></a>
</p>
...
- 🎮 **Prompt Tycoon** y **Génesis 3D** — un *idle tycoon* para Android y un juego 3D de evolución en Three.js.
- 🗞️ **LinkedIn HQ** — un enlace entra, un post sale, con métricas propias.

---

## El laboratorio

Casi todo lo que publico se cuece antes en un **laboratorio doméstico sobre Raspberry Pi 5** que es medio robot y medio servidor:
...
Escribo sobre cómo se dirige de verdad una flota de agentes, en **[el blog de Fervon](https://fervon.dev/blog/)**:

- [Qué es un estudio de software autónomo](https://fervon.dev/blog/estudio-software-autonomo/) — un desarrollador, una forja, agentes que no paran.
- [Cómo se dirige una flota de agentes de IA](https://fervon.dev/blog/flotas-agentes-ia/) — roles, límites y quién responde cuando algo se rompe.
- [Cómo saber si un agente amaña tus tests](https://fervon.dev/blog/tests-amanados-agentes/) — las señales que delatan un verde falso.
- [Cuánto cuesta de verdad un agente de IA](https://fervon.dev/blog/coste-real-agentes-ia/) — la factura completa, no solo los tokens.
...
![MCP](https://img.shields.io/badge/Model_Context_Protocol-000000?logo=anthropic&logoColor=white)
...
![llama.cpp](https://img.shields.io/badge/llama.cpp-1a1310)
![LLM tooling](https://img.shields.io/badge/LLM_tooling-ff6a00)
